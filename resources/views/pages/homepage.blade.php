            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-12 col-lg-6 position-relative order-2 order-lg-1 mt-3 mt-lg-0">
                        ...
                        <div class="floating-coal">
                            <img src="{{ asset('assets/images/coal2.png') }}" alt="Kömür">
                        </div>
                    </div>
                    <div class="col-12 col-lg-6 order-1 order-lg-2">
                        <div><img src="{{ asset('assets/images/facilities/aktif-karbon-uretim-tesisi.jpg') }}" class="img-fluid rounded-4" alt="Aktif Karbon Üretin Tesisi"></div>
                        <div class="mt-3 bg-white rounded-4 p-3 shadow">
                            <div class="row">
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-12 col-lg-6">
                        <div><img src="{{ asset('assets/images/facilities/biochar-uretim-tesisi.jpg') }}" class="img-fluid rounded-4" alt="BİOCHAR Üretim Tesisi"></div>
                        <div class="mt-3 bg-white rounded-4 p-3 shadow">
                            <div class="row">
                                <div class="col-12 col-sm text-center">
                                    <img src="{{ asset('assets/images/coal3.jpg') }}" class="img-fluid" alt="Kömür">
                                </div>
                                <div class="col-12 col-sm d-flex align-items-center mt-3 mt-sm-0">
                                    <div>
        ...
        <div class="bg-image">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-12 col-lg-6 order-1 order-lg-2">
                        <div><img src="{{ asset('assets/images/facilities/biochar-uretim-tesisi.jpg') }}" class="img-fluid rounded-4" alt="Mangal ve Nargile Kömürü üretim tesisi"></div>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div>
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-12 col-lg-6">
                        <div><img src="{{ asset('assets/images/facilities/aktif-camur-kurutma-firini.jpg') }}" class="img-fluid rounded-4" alt="Aktif Çamur Kurutma Fırını"></div>
                    </div>
                    <div class="col-12 col-lg-6 d-flex flex-column justify-content-between mt-3 mt-lg-0">
                        <div>
