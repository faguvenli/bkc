        ...
        <div class="splide__track">
            <ul class="splide__list">
                ...
                <li class="splide__slide">
                    ...
                    <img src="{{ asset('assets/images/sliders/slider2.jpg') }}" alt="BKC">
                </li>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-12 col-lg-6 d-flex flex-column justify-content-between mt-3 mt-lg-0">
                        ...
                        <div data-aos="fade-down">
                            <ul class="list-unstyled d-flex flex-column flex-sm-row justify-content-center mt-3 gap-3">
                                <li class="text-center">
                                    <div><img src="{{ asset('assets/images/home/atik-camur-3.png') }}" class="img-fluid rounded-3" alt="Karbonatlaşma bölgesinde hareketli parça yok"></div>
                                </li>
                                <li class="text-center">
                                    <div><img src="{{ asset('assets/images/home/atik-camur-1.png') }}" class="img-fluid rounded-3" alt="Sıfır Atık ve Çevre Dostu enerji kaynağı"></div>
                                </li>
                                <li class="text-center">
                                    <div><img src="{{ asset('assets/images/home/atik-camur-2.png') }}" class="img-fluid rounded-3" alt="Tam proses kontrolü"></div>
                                </li>
                            </ul>
                        </div>
                    </div>
